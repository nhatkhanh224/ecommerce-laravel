...
@endsection
<div id="logreg-forms">
        <form class="form-signin" method="post" action="{{route('homepage.loginPost')}}">
          @csrf
            ...
            <form action="{{route('homepage.signup')}}" method="post" class="form-signup">
                @csrf
                <div class="social-login">
                ...
                <p style="text-align:center">OR</p>
                <input type="text" id="user-name" name="name" class="form-control" placeholder="Tên đầy đủ" required="" autofocus="">
                ...
                <input type="password" id="user-repeatpass" class="form-control" placeholder="Lặp lại mật khẩu" required autofocus="">
